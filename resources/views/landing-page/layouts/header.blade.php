            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="header-top-left">
                        <span><i class="fas fa-fire-alt"></i> situs web perusahaan pembersih terbaik selamanya!</span>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="header-top-right">
                        <span><i class="far fa-clock"></i> Jam Kerja : {{$profil->kerja_dari_hari}}-{{$profil->kerja_sampai_hari}} ({{Carbon::parse($profil->kerja_dari_jam)->format('g:i A')}} - {{Carbon::parse($profil->kerja_sampai_jam)->format('g:i A')}})</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-3">
                    <div class="logo">
                        <a href="{{ route('beranda') }}"><img src="{{ asset('images/mami-clean/logo/'.$profil->logo) }}" alt="Logo"></a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="contact-info-item">
                                    ...
                                    <div class="content">
                                        <h4 class="title">Email Ke Kami</h4>
                            ...
                            <div class="col-md-4">
                                <div class="contact-info-item">
                                    ...
                                    <div class="content">
                                        <h4 class="title">Meminta bantuan:</h4>
                    ...
                    <div class="menu-wrap">
                        <nav class="menu-nav">
                            <div class="logo d-none">
                                <a href="{{ route('beranda') }}"><img src="{{ asset('clentac/assets/img/logo/w_logo.svg') }}" alt="Logo"></a>
                            </div>
