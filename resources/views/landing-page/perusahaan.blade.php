...
@section('title', 'Mami Clean | Perusahaan')
...
@section('content')
    @php
        ...
        $section_6 = json_decode($perusahaan->section_6, true);
    @endphp
    <!-- main-area -->
    <main>

        <!-- breadcrumb-area -->
        <section class="breadcrumb-area breadcrumb-bg" data-background="{{ asset('images/landing-page/perusahaan/'.$section_1['gambar']) }}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-10">
                        <div class="about-img-wrap">
                            <img src="{{ asset('images/landing-page/perusahaan/'.$section_2['gambar_besar']) }}" data-aos="fade-right" alt="">
                            <img src="{{ asset('images/landing-page/perusahaan/'.$section_2['gambar_kecil']) }}" data-aos="fade-up" alt="">
                            @php
                                $tahun_mulai_usaha = Carbon::parse($profil->tanggal_mulai_usaha)->year;
                                $tahun_sekarang = Carbon::now()->year;
                                $selisih_tahun = $tahun_sekarang - $tahun_mulai_usaha;
                            @endphp
                            <div class="year-experience-wrap">
                                <span class="coutn odometer" data-count="{{$selisih_tahun}}"></span>
                                <p>Bertahun-tahun <span>Pengalaman</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="about-content">
                            <div class="section-title mb-75">
                                <span class="sub-title">
                                    ...
                                    {{ $section_2?$section_2['sub_judul'] : '' }}
                                </span>
                                <h2 class="title">{{ $section_2?$section_2['judul'] : '' }}</h2>
                            </div>
                            {!! $section_2['deskripsi'] !!}
                            <div class="contact">
        ...
        <!-- services-area -->
        <section class="services-area-four inner-services-area has-animation">
            <div class="container custom-container">
                    ...
                    <div class="col-lg-6">
                        <div class="section-title text-center mb-80">
                            <span class="sub-title">
                                ...
                                {{$section_3?$section_3['sub_judul']:'' }}
                            </span>
                            <h2 class="title">{{$section_3?$section_3['judul']:'' }}</h2>
                        </div>
                    </div>
                </div>
                <div class="row services-active-two">
                    <div class="col">
                        <div class="services-item-four">
                            <div class="services-thumb-four">
                                <a href="services-details.html"><img src="{{ asset('clentac/assets/img/images/h3_services_img01.jpg') }}" alt=""></a>
                            </div>
                            <div class="services-content-four">
                                ...
                                <h3 class="title"><a href="services-details.html">Plumbing Service</a></h3>
                                <p>Lorem ipsum dolor sit consectetur. Ut tellus suspendisse nulla aliquam. Risus any time of ultrices.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="services-item-four">
                            <div class="services-thumb-four">
                                <a href="services-details.html"><img src="{{ asset('clentac/assets/img/images/h3_services_img02.jpg') }}" alt=""></a>
                            </div>
                            <div class="services-content-four">
                                <div class="services-icon">
                                ...
                                <h3 class="title"><a href="services-details.html">Office Cleaning</a></h3>
                                <p>Lorem ipsum dolor sit consectetur. Ut tellus suspendisse nulla aliquam. Risus any time of ultrices.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="services-item-four">
                            <div class="services-thumb-four">
                                <a href="services-details.html"><img src="{{ asset('clentac/assets/img/images/h3_services_img03.jpg') }}" alt=""></a>
                            </div>
                            <div class="services-content-four">
                                <div class="services-icon">
                                ...
                                <h3 class="title"><a href="services-details.html">Laundry Service</a></h3>
                                <p>Lorem ipsum dolor sit consectetur. Ut tellus suspendisse nulla aliquam. Risus any time of ultrices.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="services-item-four">
                            <div class="services-thumb-four">
                                <a href="services-details.html"><img src="{{ asset('clentac/assets/img/images/h3_services_img04.jpg') }}" alt=""></a>
                            </div>
                            <div class="services-content-four">
                                <div class="services-icon">
                                ...
                                <h3 class="title"><a href="services-details.html">Kitchen Cleaning</a></h3>
                                <p>Lorem ipsum dolor sit consectetur. Ut tellus suspendisse nulla aliquam. Risus any time of ultrices.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="services-item-four">
                            <div class="services-thumb-four">
                                <a href="services-details.html"><img src="{{ asset('clentac/assets/img/images/h3_services_img05.jpg') }}" alt=""></a>
                            </div>
                            <div class="services-content-four">
                                <div class="services-icon">
                                ...
                                <h3 class="title"><a href="services-details.html">Window Cleaning</a></h3>
                                <p>Lorem ipsum dolor sit consectetur. Ut tellus suspendisse nulla aliquam. Risus any time of ultrices.</p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- video-area -->
        <section class="video-area inner-video-area has-animation pb-130">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6 col-md-8 order-0 order-lg-2">
                        <div class="video-img-wrap">
                            <img src="{{ asset('images/landing-page/perusahaan/'.$section_4['gambar_besar']) }}" alt="">
                            <img src="{{ asset('images/landing-page/perusahaan/'.$section_4['gambar_kecil']) }}" alt="">
                            <a href="{{$section_4?$section_4['tautan'] : ''}}" class="play-btn popup-video"><i class="fas fa-play"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="video-content">
                            <div class="section-title mb-50">
                                <span class="sub-title">
                                    ...
                                    {{$section_4?$section_4['sub_judul'] : ''}}
                                </span>
                                <h2 class="title">{{$section_4?$section_4['judul'] : ''}}</h2>
                            </div>
                            <p>{!! $section_4?$section_4['deskripsi'] : '' !!}</p>
                            <ul class="list-wrap">
                                <li>
                                    <div class="list-item">
                                        <img src="{{ asset('clentac/assets/img/icon/video_icon01.svg') }}" alt="">
                                        <a href="{{ route('layanan') }}">Jasa Kebersihan Perumahan</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="list-item">
                                        <img src="{{ asset('clentac/assets/img/icon/video_icon02.svg') }}" alt="">
                                        <a href="{{ route('layanan') }}">Layanan Pembersihan Komersial</a>
                                    </div>
                                </li>
                            </ul>
                            <a href="{{ route('layanan') }}" class="btn">Temukan LEBIH BANYAK</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- history-area -->
        <section class="history-area history-bg has-animation jarallax" data-background="{{ asset('clentac/assets/img/bg/history_bg.jpg') }}">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="section-title white-title text-center mb-50">
                            <span class="sub-title">
                                ...
                                {{$section_5?$section_5['sub_judul']:'' }}
                            </span>
                            <h2 class="title">{{$section_5?$section_5['judul']:'' }}</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row history-active">
                        <div class="col-lg-3">
                            <div class="history-item">
                                ...
                                <div class="history-content">
                                    <h2 class="title">We already branches across the country</h2>
                                    <p>Lorem dolor consectetur tellus suspendisse nulla aliquam at the ultrices the pretium</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="history-item">
                                ...
                                <div class="history-content">
                                    <h2 class="title">Cleaning Authority for a Free Estimate</h2>
                                    <p>Lorem dolor consectetur tellus suspendisse nulla aliquam at the ultrices the pretium</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="history-item">
                                ...
                                <div class="history-content">
                                    <h2 class="title">We made a profit of $1 million per month</h2>
                                    <p>Lorem dolor consectetur tellus suspendisse nulla aliquam at the ultrices the pretium</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="section-title mb-100">
                            <span class="sub-title">
                                ...
                                {{$section_6?$section_6['sub_judul']:'' }}
                            </span>
                            <h2 class="title">{{$section_6?$section_6['judul']:'' }}</h2>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="team-item">
                            <div class="team-thumb">
                                <a href="team-details.html"><img src="{{ asset('clentac/assets/img/team/team_img01.jpg') }}" alt=""></a>
                            </div>
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.html">Serhii Ivanenko</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="team-item">
                            <div class="team-thumb">
                                <a href="team-details.html"><img src="{{ asset('clentac/assets/img/team/team_img02.jpg') }}" alt=""></a>
                            </div>
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.html">William Adams</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="team-item">
                            <div class="team-thumb">
                                <a href="team-details.html"><img src="{{ asset('clentac/assets/img/team/team_img03.jpg') }}" alt=""></a>
                            </div>
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.html">Dianne Russel</a></h3>
