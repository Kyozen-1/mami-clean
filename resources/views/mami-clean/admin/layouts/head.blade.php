...
<meta name="description" content="Admin Panel Mami Clean" />
<!-- Favicon Tags Start -->
...
<link rel="icon" type="image/png" href="{{ asset('images/mami-clean/logo/'.$profil->logo) }}" sizes="196x196" />
<link rel="icon" type="image/png" href="{{ asset('images/mami-clean/logo/'.$profil->logo) }}" sizes="96x96" />
<link rel="icon" type="image/png" href="{{ asset('images/mami-clean/logo/'.$profil->logo) }}" sizes="32x32" />
<link rel="icon" type="image/png" href="{{ asset('images/mami-clean/logo/'.$profil->logo) }}" sizes="16x16" />
<link rel="icon" type="image/png" href="{{ asset('images/mami-clean/logo/'.$profil->logo) }}" sizes="128x128" />
